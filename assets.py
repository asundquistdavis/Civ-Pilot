...
advancement_cards = [
    ...
    {'name': 'written record', 'price': 60, 'pgroup': 'red', 'sgroup': 'green', 'credit_to': {'name':'cartography', 'amount':10}, 'credits': {'red':5,'green':5}, 'texts': 'aquire 10 additional points of credit tokens in any combination of colors.'},
    {'name': 'cartography', 'price': 160, 'pgroup': 'green', 'credit_to': {'name': 'library', 'amount': 20}, 'credits': {'blue': 5, 'green':10}, 'texts': 'during the trade cards acquisition phase, you may acqire additional trade cards from stack 2 for 5 treasury tokens and/or from stack 7 for 13 treasury tokens per card. #piracy: if you are the primary victim, the benificiary selects and replaces 1 additional coastal city.'},
    ...
    {'name': 'universal doctrince', 'price': 160, 'pgroup': 'yellow','credit_to':{'amount':20,'name':'theology'}, 'credits': {'yellow':10,'red':5}, 'texts': '#special ability: you may choose to annex 1 pirate city or up to 5 barbarian tokens anywhere on the board. #superstition: reduce 1 additional city.'},
    ...
    {'name': 'drama and peotry', 'price': 80, 'pgroup': 'blue','credit_to':{'name':'rhetoric','amount':10}, 'credits': {'blue':10,'yellow':5}, 'texts': '#civil war: select 5 less unit points. #civil disorder: reduce 1 less city.'},
